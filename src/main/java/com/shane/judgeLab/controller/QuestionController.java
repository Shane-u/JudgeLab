...
import com.shane.judgeLab.model.dto.question.*;
...
public class QuestionController {
    ...
    /**
     * 分页获取题目提交列表（除了管理员外，普通用户只能看见非答案、提交代码的公开信息）
     *
    ...
    public BaseResponse<Page<QuestionSubmitVO>> listQuestionSubmitByPage(@RequestBody QuestionSubmitQueryRequest questionSubmitQueryRequest, HttpServletRequest request) {
        ...
        // 从数据库中查询并返回一个Page对象（没有脱敏）
        Page<QuestionSubmit> questionSubmitPage = questionSubmitService.page(new Page<>(current, size),
                questionSubmitService.getQueryWrapper(questionSubmitQueryRequest));
        // 返回脱敏信息
        User userLogin = userService.getLoginUser(request);
        return ResultUtils.success(questionSubmitService.getQuestionSubmitVOPage(questionSubmitPage, userLogin));
    }
